 ...
 *
 * Modern, creative fonts for portfolio and creative businesses
 */

export const portfolioTypography = {
  headingFont: '"Space Grotesk", "-apple-system", "BlinkMacSystemFont", sans-serif',
  ...
  h3: { fontSize: '2.25rem', fontWeight: 700, lineHeight: 1.3 },
  h4: { fontSize: '1.875rem', fontWeight: 700, lineHeight: 1.4 },
  ...
  button: { fontSize: '1rem', fontWeight: 700, lineHeight: 1.5, textTransform: 'uppercase' as const },
  label: { fontSize: '0.875rem', fontWeight: 600, lineHeight: 1.5 },
}

export default portfolioTypography
